        ...
        public static RenderTextureFormat GetUncompressedRenderTextureFormat(Texture texture)
        {
            ...
            if (texture is Texture2D)
            {
                switch ((texture as Texture2D).format)
                {
                    ...
                    //case TextureFormat.ETC2_RGBA8: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_4x4: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_5x5: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_6x6: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_8x8: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_10x10: return RenderTextureFormat.ARGB32;
                    case TextureFormat.ASTC_12x12: return RenderTextureFormat.ARGB32;
                    //case TextureFormat.ASTC_4x4: return RenderTextureFormat.ARGB32;
                    //case TextureFormat.ASTC_5x5: return RenderTextureFormat.ARGB32;
                    //case TextureFormat.ASTC_6x6: return RenderTextureFormat.ARGB32;
                    //case TextureFormat.ASTC_8x8: return RenderTextureFormat.ARGB32;
